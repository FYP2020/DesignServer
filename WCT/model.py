...
import numpy as np
from WCT.vgg_normalised import vgg_from_t7
from keras import backend as K
from keras.models import Model
from keras.layers import Input, UpSampling2D, Lambda
from WCT.ops import pad_reflect, Conv2DReflect, torch_decay, wct_tf, wct_style_swap, adain
...
class WCTModel(object):
    ...
    def __init__(self, mode='train', relu_targets=['relu5_1','relu4_1','relu3_1','relu2_1','relu1_1'], vgg_path="WCT/models/vgg_normalised.t7",
                 *args, **kwargs):
        '''
            Args:
